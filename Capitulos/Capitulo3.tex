...
Os cenários de destaque nessa visualização são dois, em particular: o que possuiu maior porcentagem de desvio de desempenho e o que possuiu maior tempo de execução, indicados, respectivamente, pela largura e altura de uma fatia. Dentre esses dois cenários, a principal indicação da visualização é o que possuiu maior porcentagem desvio de desempenho em relação a versão anterior: o cenário com maior largura no gráfico. Assim sendo, o cenário \texttt{B} requer maior atenção por parte dos desenvolvedores do que o cenário \texttt{A}.
