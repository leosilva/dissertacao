...
A visualização da Sumarização de Cenários mostra todos os cenários identificados com desvios de desempenho (otimização ou degradação) entre duas versões do sistema. Ao final da análise das releases selecionadas, os cenários analisados, com degradações e com otimizações estão mostrados nas tabelas \ref{tab:summary-jetty} para o Jetty, e \ref{tab:summary-vraptor} para o VRaptor.
